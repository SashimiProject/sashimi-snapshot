<template>
  <UiModal :open="open" @close="$emit('close')">
    ...
    <div class="text-center">
      <a href="https://twitter.com/SASHIMISASHIMI5" target="_blank">
        <Icon size="32" name="twitter" class="mr-1 mx-2" />
      </a>
      <a href="https://discord.gg/zTdmUkb" target="_blank">
        <Icon size="32" name="discord" class="mr-1 mx-2" />
      </a>
      <a href="https://t.me/joinchat/KABj-Bz6CVzyi23HK2rjzA" target="_blank">
        <Icon size="32" name="telegram" class="mr-1 mx-2" />
      </a>
      <a href="https://github.com/AElfProject/Sashimi" target="_blank">
